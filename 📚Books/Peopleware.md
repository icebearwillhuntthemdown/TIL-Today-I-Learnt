...
> * 결과에서 생산성이 밀접한 영향을 미친다고 밝혀진 요인 하나는 다소 의외였다. 짝이 누구인지가 아주 중요했다. (중략) 이것이 왜 중요할까? 과제는 따로 수행했지만 두 사람이 같은 회사에서 일하기 때문이다. (중략) 즉, 어떤 조직은 최고의 개발자들이 모여들고 어떤 조직은 최악의 개발자들이 모여든다는 의미다. 
